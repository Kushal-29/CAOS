...
import {
  ...
  ChevronRight, FileSpreadsheet, X, Edit3, Trash2, AlertTriangle
} from 'lucide-react';
              ...
              <div className="pt-3 border-t border-slate-100 dark:border-slate-700 flex items-center justify-between text-xs">
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-2 py-1 text-xs font-semibold text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-950 rounded-lg flex items-center gap-1"
                  >
                    <Edit3 className="w-3.5 h-3.5" /> Edit
                  </button>
                  <button
                    onClick={() => setDeletingClient(c)}
                    className="px-2 py-1 text-xs font-semibold text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950 rounded-lg flex items-center gap-1"
                  >
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 max-w-md w-full border border-slate-200 dark:border-slate-700 shadow-2xl space-y-4">
            <div className="flex items-center gap-3 text-rose-600">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 font-mono">{deletingClient.clientCode}</p>
              </div>
            </div>

            <p className="text-xs text-slate-600 dark:text-slate-300">
              Are you sure you want to delete <strong className="text-slate-900 dark:text-white">{deletingClient.name}</strong>? This action cannot be undone and will permanently remove all associated GST returns, ITR filings, tasks, and documents.
            </p>
